...
<!-- main body -->
    ...
    <form class="col-lg-6 " action="s_insert.php" method="POST">
        <div class="login-form">
            ...
            <div class="form-group col-md-6">
                ...
                <input name="Uname" type="text" class="form-control" id="inputAddress" placeholder="Shope Name" required>
            </div>
            <div class="row form-row">
                <div class="form-group col-md-6">
            ...
            <div class="form-group">
                <label for="inputAddress">Shope Address</label>
            ...
            <div class="row form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input name="mobile" type="number" class="form-control" id="inputCity" placeholder="+9230000000"
                        required>
                </div>
            </div>
            <div class="row form-row">
