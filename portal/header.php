...
<!-- top header end -->
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
        ...
        <li class="nav-item dropdown ">
          ...
          <?php
            ...
            <li><a class='dropdown-item' href='pc.php?Cat=$row[categories]'>$row[categories]</a></li>
      ...
      <h5><a class="nav-link" href="view-cart.php">
      <span class="mx-3"><i class="fa-solid fa-cart-shopping"></i> Cart(<?php echo $count; ?>)</span></a>
      </h5>
      <?php 
    ...
    <ul class='navbar-nav'>
      <li class='nav-item dropdown text-decoration-none'>
          ...
          <ul class='dropdown-menu' aria-labelledby='navbarDropdown'>
            ...
            <hr>
            <li><a class='dropdown-item' href='purc_history.php'>Purchasing History</a></li>
            <hr>
 ...
 ";
  ...
  <nav class="navbar navbar-expand p-0 navbar-light bg-light" >
  <div class="container-fluid">
      ...
      <ul class="navbar-nav">
         <li class="nav-item dropdown ">
          ...
          <?php
            ...
            <li><a class='dropdown-item' href='pc.php?Cat=$row[categories]'</a> $row[categories]</li>
          ...
          <?php
           ...
           <li class='nav-item'>
          <a class='nav-link' href='pc.php?Cat=$row[categories]'>$row[categories]</a>
        </li>
